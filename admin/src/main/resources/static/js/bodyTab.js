...
layui.define(["element", "jquery"], function (exports) {
    ...
    Tab.prototype.tabAdd = function (_this) {
        ...
        if (_this.attr("target") == "_blank") {
            ...
            if (!url.startsWith(app.ctxPath()) && !url.startsWith("http://") && !url.startsWith("https://") && !url.startsWith("ftp://")) {
                url = app.ctxPath() + url;
            }
            var title = '';
            ...
            if (that.hasTab(_this.find("cite").text()) == -1 && _this.siblings("dl.layui-nav-child").length == 0) {
                ...
                title += '<i class="fa fa-close" style="margin-left: 8px;"></i>';
    ...
    //删除tab
    $("body").on("click", ".top_tab li i.fa-close", function () {
